...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'80408d38'])
Z([3,'_view data-v-48fb118c page-panel-h'])
Z([3,'_view data-v-48fb118c music-name'])
Z([a,[[6],[[7],[3,'musicDetail']],[3,'name']]])
Z([3,'_view data-v-48fb118c music-author'])
Z([a,[[6],[[7],[3,'musicDetail']],[3,'author']]])
Z([3,'_view data-v-48fb118c music-pic'])
Z([3,'_image data-v-48fb118c'])
Z([[6],[[7],[3,'musicDetail']],[3,'picUrl']])
Z([3,'_view data-v-48fb118c player-panel'])
Z([3,'_view data-v-48fb118c time'])
Z([3,'_view data-v-48fb118c item'])
...
Z([3,'_view data-v-48fb118c player-btn'])
Z([3,'_view data-v-48fb118c nextPrev'])
Z(z[7])
Z([3,'../../static/images/prev.png'])
Z([[7],[3,'isStop']])
Z(z[16])
Z([3,'_view data-v-48fb118c playStop'])
Z(z[19])
Z([1,'80408d38-1'])
Z(z[7])
