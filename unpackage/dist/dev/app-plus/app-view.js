...
Z([a,[[6],[[7],[3,'musicTime']],[3,'currentTime']],[[6],[[7],[3,'musicTime']],[3,'duration']]])
...
var x=['./common/slots.wxml','/components/nowPlay.vue.wxml','/components/programsList.vue.wxml','/components/songList.vue.wxml','/components/djRecommendList.vue.wxml','/components/mvList.vue.wxml','/components/mvListT.vue.wxml','./components/djRecommendList.vue.wxml','./components/mvList.vue.wxml','./components/mvListT.vue.wxml','./components/nowPlay.vue.wxml','./components/programsList.vue.wxml','./components/songList.vue.wxml','./pages/djList/djList.vue.wxml','./pages/djList/djList.wxml','./djList.vue.wxml','./pages/getPlaylistDetail/getPlaylistDetail.vue.wxml','./pages/getPlaylistDetail/getPlaylistDetail.wxml','./getPlaylistDetail.vue.wxml','./pages/index/index.vue.wxml','./pages/index/index.wxml','./index.vue.wxml','./pages/mv/mv.vue.wxml','./pages/mv/mv.wxml','./mv.vue.wxml','./pages/mvDetail/mvDetail.vue.wxml','./pages/mvDetail/mvDetail.wxml','./mvDetail.vue.wxml','./pages/mvList/mvList.vue.wxml','./pages/mvList/mvList.wxml','./mvList.vue.wxml','./pages/personalizedList/personalizedList.vue.wxml','./pages/personalizedList/personalizedList.wxml','./personalizedList.vue.wxml','./pages/play/play.vue.wxml','./pages/play/play.wxml','./play.vue.wxml','./pages/ranking/ranking.vue.wxml','./pages/ranking/ranking.wxml','./ranking.vue.wxml','./pages/rankingList/rankingList.vue.wxml','./pages/rankingList/rankingList.wxml','./rankingList.vue.wxml','./pages/singerInfo/singerInfo.vue.wxml','./pages/singerInfo/singerInfo.wxml','./singerInfo.vue.wxml'];d_[x[0]]={}
...
cs.pop()
_(xC,fE)
cs.push("./components/nowPlay.vue.wxml:view:1:366")
var hG=_n('view')
...
cs.pop()
_(xC,hG)
cs.push("./components/nowPlay.vue.wxml:image:1:458")
var cI=_mz(z,'image',['mode',-1,'class',13,'src',1],[],e,s,gg)
cs.pop()
_(xC,cI)
cs.pop()
_(oB,xC)
cs.push("./components/nowPlay.vue.wxml:view:1:549")
var oJ=_n('view')
...
_ai(c8,x[6],e_,x[22],1,46)
c8.pop()
c8.pop()
return r
}
e_[x[22]]={f:m13,j:[],i:[],ti:[x[1],x[6]],ic:[]}
d_[x[23]]={}
...
_(oB,cI)
cs.push("./pages/play/play.vue.wxml:view:1:407")
var oJ=_n('view')
_rz(z,oJ,'class',10,e,s,gg)
cs.push("./pages/play/play.vue.wxml:view:1:456")
var lK=_n('view')
_rz(z,lK,'class',11,e,s,gg)
cs.push("./pages/play/play.vue.wxml:view:1:503")
var eN=_n('view')
_rz(z,eN,'class',12,e,s,gg)
cs.push("./pages/play/play.vue.wxml:image:1:548")
var bO=_mz(z,'image',['mode',-1,'class',13,'src',1],[],e,s,gg)
cs.pop()
_(eN,bO)
cs.pop()
_(lK,eN)
...
cs.push("./pages/play/play.vue.wxml:view:1:641")
cs.push("./pages/play/play.vue.wxml:view:1:641")
var oP=_mz(z,'view',['bindtap',16,'class',1,'data-comkey',2,'data-eventid',3],[],e,s,gg)
cs.push("./pages/play/play.vue.wxml:image:1:780")
...
cs.push("./pages/play/play.vue.wxml:view:1:874")
cs.push("./pages/play/play.vue.wxml:view:1:874")
var oR=_mz(z,'view',['bindtap',23,'class',1,'data-comkey',2,'data-eventid',3],[],e,s,gg)
cs.push("./pages/play/play.vue.wxml:image:1:1014")
...
cs.push("./pages/play/play.vue.wxml:image:1:1157")
...
_ai(xOC,x[5],e_,x[43],1,92)
xOC.pop()
xOC.pop()
xOC.pop()
return r
}
e_[x[43]]={f:m27,j:[],i:[],ti:[x[1],x[3],x[5]],ic:[]}
d_[x[44]]={}
