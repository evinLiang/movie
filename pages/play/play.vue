<template>
	<view class="page-panel-h">
		...
		<view class="player-panel">
			<view class="time"><view class="item">{{musicTime.currentTime}}</view><view class="item">{{musicTime.duration}}</view></view>
			<slider :value="musicTime.currentTime" step="0.01" @changing="sliderChange" min="0" :max="musicTime.duration" block-size="12" activeColor="#E91E63"/>
